...
ARG REACT_APP_SERVER_BASE_URL=https://crm.4ow4.com
...
LABEL org.opencontainers.image.source=https://github.com/yourusername/ProPods2
LABEL org.opencontainers.image.description="Custom CRM application based on Twenty"
